{{-- resources/views/areas/rsu/create.blade.php --}}
@extends('layouts.app')
@section('content')
<div class="container mx-auto py-6">
    <h1 class="text-2xl font-bold mb-4">Nuevo Proyecto RSU</h1>
    <form action="{{ route('rsu.store') }}" method="POST" class="bg-white p-6 rounded shadow">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="descripcion" class="border rounded w-full px-3 py-2"></textarea>
        </div>
        <div class="mb-4">
