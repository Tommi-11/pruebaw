<div class="mb-6 p-4 bg-blue-50 rounded shadow">
    <!--[if BLOCK]><![endif]--><?php if(session()->has('success')): ?>
        <div class="mb-4 text-green-700 font-semibold"><?php echo e(session('success')); ?></div>
...
<?php /**PATH C:\xampp\htdocs\sisogrsu1\resources\views/livewire/user-create-form.blade.php ENDPATH**/ ?>