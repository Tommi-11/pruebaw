                            ...
                            <div class="swiper-slide h-full">
                                <div class="bg-white rounded-lg shadow-md flex flex-col overflow-hidden h-full">
                                    ...
                                    <div class="p-4 flex-1 flex flex-col">
                                        <h3 class="font-semibold text-blue-800 text-lg mb-1"><?php echo e($noticia->titulo); ?></h3>
                                        <!-- <p class="text-sm text-gray-600 flex-1"><?php echo e(strip_tags($noticia->descripcion)); ?></p> -->
